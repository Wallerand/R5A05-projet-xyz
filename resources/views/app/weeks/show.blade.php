<x-app title="2024-S37">
    <main class="container-wide two-cols space-y-8">

        <section>
            <h1>
                2024-S37 <small>{{ trans_choice('tracks.count', 15) }}</small>
            </h1>
            ...
            <ol class="chart">
                <li>
                    <a href="">
                        ...
                        <div class="details">
                            <h1 class="truncate">Artiste</h1>
                            <h2 class="truncate">Titre</h2>
                            ...
                            <div class="metadata">
                                ...
                                <div class="metadata-item">
                                    ...
                                    <span>{{ trans_choice('tracks.likes', 3) }}</span>
                                </div>
                            </div>
                        </div>
                        <div>
